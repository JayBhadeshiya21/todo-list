...
async function GET(request) {
    ...
    try {
        ...
        const tasks = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].tasks.findMany({
            where: whereClause,
            include: {
                tasklists: true,
                users: {
...
async function POST(request) {
    try {
        ...
        const newTask = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].tasks.create({
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__31d77898._.js.map